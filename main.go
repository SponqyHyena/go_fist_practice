...
func (r Running) Calories() float64 {
	...
	// ((18 * meanSpeed + 1.79) * weight / m_in_km * hours * MinInHours)
...
func (w Walking) Calories() float64 {
	...
	return (CaloriesWeightMultiplier*w.Weight + (math.Pow(speedMS, 2)/heightM)*CaloriesSpeedHeightMultiplier*w.Weight) * hours * MinInHours
}
...
func (s Swimming) meanSpeed() float64 {
	...
	distanceKm := s.LengthPool * float64(s.CountPool) / MInKm
